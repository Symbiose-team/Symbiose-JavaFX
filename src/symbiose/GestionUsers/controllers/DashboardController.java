...
//                tray.setNotificationType(NotificationType.SUCCESS);
    ...
    private void leaderboard(MouseEvent event) throws IOException {
        ...
        if (role.equals("Admin")){
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/symbiose/GestionMatches/gui/Admin.fxml"));
            Parent root = (Parent) loader.load();
            contentPane.getChildren().add(root);

        }
        else{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/symbiose/GestionMatches/gui/Client.fxml"));
            Parent root = (Parent) loader.load();
            contentPane.getChildren().add(root);
