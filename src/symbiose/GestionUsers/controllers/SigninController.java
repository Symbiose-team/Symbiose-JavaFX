...
//                        System.out.println("Logged in as "+user.getRole(user.getUserId()));
//                    }
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/symbiose/GestionUsers/views/Dashboard.fxml"));
                    Parent root = (Parent) loader.load();
                    DashboardController sp = loader.getController();
                    sp.setUserId(res);
                    stage.setScene(new Scene(root));
...
//                    stage.show();
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/symbiose/GestionUsers/views/AdminDash.fxml"));
                    Parent root = (Parent) loader.load();
                    AdminDashController asp = loader.getController();
                    asp.setUserId(res);
                    stage.setScene(new Scene(root));
    ...
    private void resetAction(ActionEvent event) {
        try {
            ...
            // Animation
            Parent root = FXMLLoader.load(getClass().getResource("/symbiose/GestionUsers/views/resetP.fxml"));
            Scene SigninScene = open_signup.getScene();
            root.translateYProperty().set(SigninScene.getHeight());
            stackPane.getChildren().add(root);
            Timeline timeline = new Timeline();
...
// Set the icon (must be included in the project).
        dialog.setGraphic(new ImageView(this.getClass().getResource("/symbiose/Images/symbiose-logo.png").toString()));
